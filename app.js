...
tl.addLabel("start")
    .from(".box1", {scale: 2.5})
    .addLabel("snap0")
    .to(".box1", {yPercent: 100})
    .fromTo(".box2", {yPercent: -150, scale: 2}, {yPercent: 0, scale: 1}, "-=1.5")
    .addLabel("snap1")
    .to(".box2", {xPercent: -100})
    .from(".box3", {xPercent: 100}, "-=1.5")
    .addLabel("snap2")
    ...
    .addLabel("snap3")
    .to(".box4", {xPercent: 150})
    .from(".box5", {yPercent: 100}, "-=1.5")
    .addLabel("snap5")
    .to(".box5", {xPercent: 100})
