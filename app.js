...
tl.addLabel("start")
    ...
    .fromTo(".h1", {xPercent: 200, yPercent: 500, scale: 0, opacity: 0}, {opacity: 1, xPercent: 50,yPercent: 60, scale: 2}, "-=2.5")
    .fromTo(".h2", {xPercent: -200,yPercent: 500, scale: 0, opacity: 0}, {opacity: 1, xPercent: -50,yPercent: 60, scale: 2}, "-=2.5")
    .addLabel("snap1")
    .to(".h1, .h2", {opacity: 0}, "-=1")
