...
tl.addLabel("start")
    ...
    .fromTo(".h1", {xPercent: 200, yPercent: 500, scale: 0, opacity: 0}, {opacity: 1, xPercent: 0,yPercent: 20, scale: 1}, "-=2.5")
    .fromTo(".h2", {xPercent: -200,yPercent: 500, scale: 0, opacity: 0}, {opacity: 1, xPercent: 0,yPercent: 20, scale: 1}, "-=2.5")
    .addLabel("snap1")
    .to(".h1, .h2", {opacity: 0})
    .to(".box2", {yPercent: 100, opacity: 0}, "-=0.5")
    .from(".box3", {xPercent: 100}, "-=1")
    .addLabel("snapoo")
    .fromTo(".h3", {yPercent: 100, opacity: 0}, {yPercent: 0, opacity: 1})
    .addLabel("snap2")
