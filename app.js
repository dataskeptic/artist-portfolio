...
tl.addLabel("start")
    ...
    .fromTo(".box2", {yPercent: -150, scale: 1.5}, {yPercent: 0, scale: 1}, "-=1")
    .fromTo(".h1", {xPercent: 200, yPercent: 500, scale: 0, opacity: 0}, {opacity: 1, xPercent: 0,yPercent: 60, scale: 2}, "-=2.5")
    .fromTo(".h2", {xPercent: -200,yPercent: 500, scale: 0, opacity: 0}, {opacity: 1, xPercent: 0,yPercent: 60, scale: 2}, "-=2.5")
    .addLabel("snap1")
    .to(".h1, .h2", {opacity: 0})
    .to(".box2", {yPercent: 100, opacity: 0}, "-=0.5")
    .from(".box3", {xPercent: 100}, "-=1")
    .addLabel("snapoo")
    .fromTo(".h3", {yPercent: 100, scale: 1.5, opacity: 0}, {yPercent: 0, scale: 1.5, opacity: 0.9})
    .addLabel("snap2")
    ...
    .fromTo(".h4", {scale: 1.5, opacity: 0, yPercent: 50}, {scale: 1.5, opacity: 0.9, yPercent: 0})
    .addLabel("snap5")
    .to(".box5", {yPercent: -100, opacity: 0})
    .from(".box6", {xPercent: -100}, "-=1")
    .addLabel("snap6")
    .to(".box6", {opacity: 0})
